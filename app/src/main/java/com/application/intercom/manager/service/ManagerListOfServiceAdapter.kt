...
import com.application.intercom.user.service.UserListOfServiceAdapter
import com.application.intercom.utils.loadImagesWithGlideExt


class ManagerListOfServiceAdapter(
    val con: Context,
    val list: ArrayList<UserServiceProviderResponse.Data.Result>,
    var fromSearch: Boolean,
    val onPress: CallService
) :
    RecyclerView.Adapter<ManagerListOfServiceAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.mView.ivServiceProviderIcon.loadImagesWithGlideExt(data.photo)
        holder.mView.textView16.text = data.serviceProviderName
        holder.mView.textView17.text = data.address
        holder.mView.textView18.text =
            con.getString(R.string.service_provider_charge, data.charges.toString())
