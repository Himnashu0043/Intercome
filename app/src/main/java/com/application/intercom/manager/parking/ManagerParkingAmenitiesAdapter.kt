...
class ManagerParkingAmenitiesAdapter(
    private val context: Context, val list:ArrayList<String>
) : RecyclerView.Adapter<ManagerParkingAmenitiesAdapter.MyViewHolder>() {
    class MyViewHolder (mView: ItemManagerParkingToLetParkingBinding): RecyclerView.ViewHolder(mView.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        return  MyViewHolder(ItemManagerParkingToLetParkingBinding.inflate(LayoutInflater.from(context),parent,false))
    }
