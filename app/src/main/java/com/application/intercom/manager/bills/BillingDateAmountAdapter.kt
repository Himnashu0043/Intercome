...
class BillingDateAmountAdapter(
    val context: Context, var list: ArrayList<DateModelWithName>, var edit: String,
    val unCheck: () -> Unit = {}
) :
    RecyclerView.Adapter<BillingDateAmountAdapter.MyViewHolder>() {
    var positioncheck:Int = -1
    class MyViewHolder(val mView: NewServiceChargeItemBinding) : RecyclerView.ViewHolder(mView.root)
    fun removeItem(list1: java.util.ArrayList<DateModelWithName>, position: Int) {
        this.list = list1
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.mView.edtDueDate2.setOnClickListener {
            ...
            val datePickerDialog = DatePickerDialog(
                context, { _: DatePicker, selectedYear: Int, selectedMonth: Int, dayOfMonth: Int ->
