...
import com.application.intercom.databinding.ActivityBalanceExpneseReportBinding
...
class BalanceExpneseReportActivity : AppCompatActivity() {
    lateinit var binding: ActivityBalanceExpneseReportBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityBalanceExpneseReportBinding.inflate(layoutInflater)
                ...
                is EmpResource.Success -> {
                    ...
                    it.value.let {
                        if (it.status == AppConstants.STATUS_SUCCESS) {
                            ...
                            val adptr = BalanceExpensesReportAdapter(this, list)
