...
import com.application.intercom.databinding.FragmentCompletedGatePassOwnerBinding
...
class CompletedGatePassOwnerFragment(val flatOfBuildingId: String) : Fragment(),
    OwnerGatePassAdapter.Click {

    lateinit var binding: FragmentCompletedGatePassOwnerBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentCompletedGatePassOwnerBinding.inflate(layoutInflater)
    ...
    private fun gatePassListOwner() {
        ...
        viewModel.gatePassListOwner(token, "complete", flatOfBuildingId)
    }
