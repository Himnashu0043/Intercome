...
class HomeServicesOfferBannerAdapter(
    private val context: Context, val list: ArrayList<String>
) : RecyclerView.Adapter<HomeServicesOfferBannerAdapter.MyViewHolder>() {
    class MyViewHolder(mView: ItemHomeOfferBannerBinding) : RecyclerView.ViewHolder(mView.root)
