...
class PendingAdapter(val con: Context, val list: ArrayList<ActiveNewPhaseList.Data>) :
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.mView.imageView13611.visibility = View.INVISIBLE
        holder.mView.imageView1361.visibility = View.VISIBLE
        holder.mView.constraintLayout19.visibility = View.GONE
        ...
        holder.mView.imageView138.setOnClickListener {
            if (holder.mView.listPop.visibility == View.VISIBLE) {
                ...
                holder.mView.tvInActive.visibility = View.GONE
            }
        ...
        holder.mView.tvEdit.setOnClickListener {
            /* con.startActivity(Intent(con, LetGetReadyActivity::class.java))*/
            con.startActivity(
